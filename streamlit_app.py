...
# Add the 'backend' directory to Python's sys.path so all internal package imports ('from app import models...') resolve cleanly
...
# Import core backend modules using consistent 'app' package namespace
